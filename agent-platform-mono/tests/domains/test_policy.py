...
async def test_query_policy_basic_success():
    from domains.policy.tools.policy_tools import query_policy_basic
    mock_data = {
    ...
    with patch("domains.policy.tools.policy_tools.gateway_client.get",
...
async def test_policy_register():
    ...
    from domains.policy.register import register
    register()
